...
export default function DutchHomePage() {
  ...
  return (
    <>
      <HreflangTagsServer pathname="/nl" currentLocale="nl" />
        ...
        <main className="container mx-auto px-4 py-16 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              ...
              >
                Premium Natuurlijke Honing van Duurzame Bijenteelt
              </motion.p>
            </motion.div>
            ...
            <div className="mb-16">
              <h2 className="text-5xl font-bold text-white mb-8 text-shadow font-heading">
                Ontdek Natuurs Zoetste Geschenk uit Polen
              </h2>
              <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
                Ervaar de pure smaak van natuurlijke honing, zorgvuldig geoogst van onze 
                duurzame bijenteeltpraktijken. Elke pot bevat de essentie van 
                natures fijnste nectar, vervaardigd met luxe en zorg.
              </p>
              
              {/* CTA Buttons */}
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <Link href="/nl/products" className="btn-primary luxury-pulse">
                  <span className="relative z-10">Shop Nu</span>
                </Link>
                <Link href="/nl/about" className="btn-secondary">
                  Meer Informatie
                </Link>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-yellow-400 mb-4 font-heading">100% Natuurlijk</h3>
                <p className="text-gray-300 leading-relaxed font-body">Pure honing zonder toevoegingen of conserveringsmiddelen, zorgvuldig geoogst</p>
              </motion.div>
              <motion.div 
                className="card-luxury group text-center p-8"
                initial={{ opacity: 0, y: 50 }}
              ...
              >
                <div className="text-4xl mb-6 group-hover:scale-110 transition-transform duration-300 luxury-float">🐝</div>
                <h3 className="text-2xl font-bold text-yellow-400 mb-4 font-heading">Duurzaam</h3>
                <p className="text-gray-300 leading-relaxed font-body">Ethische bijenteeltpraktijken die ons milieu en toekomst beschermen</p>
              </motion.div>
              <motion.div 
                className="card-luxury group text-center p-8"
                initial={{ opacity: 0, y: 50 }}
              ...
              >
                <div className="text-4xl mb-6 group-hover:scale-110 transition-transform duration-300 luxury-float">🏆</div>
                <h3 className="text-2xl font-bold text-yellow-400 mb-4 font-heading">Premium Kwaliteit</h3>
                <p className="text-gray-300 leading-relaxed font-body">Zorgvuldig geselecteerd en getest voor de hoogste luxe standaarden</p>
              </motion.div>
            </div>
          </div>
        </main>
      ...
      {/* Products Section */}
              <ProductsSection locale="nl" />

      {/* Testimonials & Payment Methods Section */}
      <TestimonialsSection locale="nl" />

      {/* Newsletter Signup Section */}
      <section className="py-16 bg-gradient-to-br from-yellow-50 to-orange-50">
        <div className="container mx-auto px-4">
          <NewsletterSignup locale="nl" />
        </div>
      </section>
    </>
  );
