...
export default function PolishContactPage() {
  ...
  return (
    <>
      <HreflangTagsServer pathname="/pl/contact" currentLocale="pl" />
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-yellow-50 to-orange-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-8 relative z-10">
          ...
          >
            ...
            >
              Masz pytania dotyczące naszego miodu? Chcesz dowiedzieć się więcej o zrównoważonej pszczelarstwie? 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  >
                    <label className="block text-gray-700 font-semibold mb-2">
                      Twoje Imię <span className="text-yellow-500">🐝</span>
                    </label>
                  ...
                  >
                    <label className="block text-gray-700 font-semibold mb-2">
                      Adres Email <span className="text-yellow-500">📧</span>
                    </label>
                    <div className="relative">
                      <input
                        type="email"
                  ...
                  >
                    ...
                    <div className="relative">
                      <textarea
                        ...
                        placeholder="Powiedz nam, co masz na myśli..."
                      />
                  ...
                  {showSuccess && (
                    ...
                    >
                      <div className="flex items-center justify-center space-x-2">
                        ...
                        <span className="font-semibold">Wiadomość wysłana pomyślnie!</span>
                      </div>
                      <p className="text-sm mt-1 opacity-90">Odpowiemy wkrótce!</p>
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
            ...
            >
              ...
              <div className="space-y-6">
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900">Zadzwoń do Nas</h3>
                      <p className="text-gray-600">+1 (555) 123-4567<br />Pon-Pt 9:00-18:00</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900">Napisz do Nas</h3>
                      <p className="text-gray-600">honeyfy.online@gmail.com<br />Odpowiadamy w ciągu 24 godzin</p>
                    </div>
                  </div>
                </motion.div>
              </div>
              ...
              <motion.div
                ...
                transition={{ delay: 0.8 }}
              >
                <h3 className="text-2xl font-bold mb-4">🐝 Ciekawe Fakty o Pszczołach</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-center space-x-2">
                    <span>🍯</span>
                    <span>Jedna pszczoła produkuje tylko 1/12 łyżeczki miodu w swoim życiu</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <span>🏃</span>
                    <span>Pszczoły mogą latać z prędkością do 24 km/h</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <span>👑</span>
                    <span>Królowa pszczół może złożyć do 2000 jaj dziennie</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <span>🌺</span>
                    <span>Pszczoły odwiedzają 2 miliony kwiatów, aby wyprodukować 1 funt miodu</span>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                transition={{ delay: 0.9 }}
              >
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Śledź Naszą Podróż</h3>
